  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-8 mb-12 md:grid-cols-2 lg:grid-cols-3">
        <StatsCard title="Total Products" value={stats.count} change={12.5} icon="P" />
        <StatsCard
          ...
          icon="R"
        />
        <StatsCard title="Orders Today" value={stats.count} change={-3.1} icon="O" />
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2">
          <div className="p-8 bg-white border border-gray-100 shadow-lg rounded-2xl">
            ...
            <p className="text-gray-500">Product and order activity updates will appear here.</p>
          </div>
        </div>
        <div>
          <div className="p-8 text-white shadow-xl bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl">
            ...
            <Link
              to="/products"
              className="block w-full p-4 mb-4 font-semibold text-center transition-all bg-white/20 backdrop-blur-sm rounded-xl hover:bg-white/30"
            >
              Add Product
            </Link>
            <Link
              to="/orders"
              className="block w-full p-4 font-semibold text-center transition-all bg-white/20 backdrop-blur-sm rounded-xl hover:bg-white/30"
            >
              View Orders
            </Link>
          </div>
